...
export default function Navbar() {
  return (
    <nav className='py-'>
      <main className='container mx-auto flex items-center md:gap-10 gap-6'>
        ...
        <div className='xl:basis-[10%] md:basis-[20%] basis-[25%] mx-auto text-right'>
         ...
         hover:text-white transition-all md:px-8 px-4 py-2 rounded-full border-2 border-[#1565D8]
